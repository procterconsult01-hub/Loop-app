...
// NOTE: STUN alone won't traverse every network (symmetric NATs, some corporate
// firewalls). Production deployments should add a TURN server (e.g. coturn,
// Twilio Network Traversal) as a fallback relay.
